...
class Contacts:
    ...
    def create_left_icon(self):
        photo = PhotoImage(file='./images/contact1.gif')
    ...
    def create_label_frame(self):
        ...
        labelframe.grid(row=1, column=1, pady=8, sticky='ew')
    ...
    def create_bottom_buttons(self):
        Button(text='Delete Contact', command=self.on_delete_selected_button_clicked, bg="black", fg="white").grid(row=8, column=0, sticky=W, padx=10, pady=20)
